...
const Footer = () => {
  return (
    <div>
      <footer className="footer  py-40 px-4 bg-black text-neutral-content text-xl" data-aos="fade-up"
     data-aos-duration="3000">
          <div className="lg:w-[1280px]  lg:mx-auto  justify-between mb-20">
          <div className="grid grid-cols-2 gap-2 lg:flex justify-between lg:w-[1280px]">
          <div>
          <h1 className="text-4xl">CRESTVIEW <br /> <span className="text-orange-400">ESTATES</span></h1>
          </div>
